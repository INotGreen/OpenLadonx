...
fn default_workspace_source() -> String {
    "codex".to_string()
}
...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub(crate) struct LadonxAuthState {
...
pub(crate) struct AppSettings {
    ...
    #[serde(default, rename = "ladonxAuth")]
    pub(crate) ladonx_auth: Option<LadonxAuthState>,
    #[serde(default, rename = "codexBaseUrl")]
    pub(crate) codex_base_url: Option<String>,
    #[serde(default = "default_api_source_mode", rename = "apiSourceMode")]
    pub(crate) api_source_mode: String,
    #[serde(default, rename = "customResponseApi")]
    pub(crate) custom_response_api: Option<CustomApiConfig>,
    #[serde(default, rename = "customMessagesApi")]
    pub(crate) custom_messages_api: Option<CustomApiConfig>,
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub(crate) enum AppUpdateDownloadState {
    Idle,
    Downloading,
    Downloaded,
    Error,
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub(crate) struct AppUpdatePlatformInfo {
    pub(crate) os: String,
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub(crate) struct AppUpdateDownloadStatus {
    pub(crate) state: AppUpdateDownloadState,
    #[serde(default)]
    pub(crate) version: Option<String>,
    #[serde(default)]
...
fn default_api_source_mode() -> String {
    "default".to_string()
}
...
fn default_remote_backend_host() -> String {
    crate::settings::DEFAULT_REMOTE_BACKEND_HOST.to_string()
}

fn default_remote_backend_token() -> Option<String> {
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            ladonx_auth: None,
            codex_base_url: None,
            api_source_mode: default_api_source_mode(),
            custom_response_api: None,
            custom_messages_api: None,
            backend_mode: default_backend_mode(),
            remote_backend_provider: RemoteBackendProvider::Tcp,
            remote_backend_host: default_remote_backend_host(),
            remote_backend_token: default_remote_backend_token(),

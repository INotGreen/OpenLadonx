...
export type ThreadState = {
  ...
  interruptedTurnIdByThread: Record<string, string | null>;
};
...
export type ThreadAction =
  ...
  | {
      ...
      patch: Partial<
        Pick<
          ThreadSummary,
          "isSubagent" | "subagentNickname" | "subagentRole" | "createdAt" | "filePath"
        >
      >;
    }
  | {
  ...
  | { type: "setInterruptedTurnId"; threadId: string; turnId: string | null }
  ...
  | { type: "setThreadGoal"; threadId: string; goal: ThreadGoal | null }
  | {

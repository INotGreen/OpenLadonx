...
export function SettingsOpenAppsSection({
  ...
  return (
    <SettingsSection
      title={String(t('settings.sections.openApps'))}
      subtitle={String(t('settings.openAppsDescription'))}
    >
            ...
            >
              ...
              <div className="settings-open-app-fields">
                <label className="settings-open-app-field settings-open-app-field--label">
                  <span className="settings-visually-hidden">{String(t('settings.placeholders.label'))}</span>
                  <input
                    className="settings-input settings-input--compact settings-open-app-input settings-open-app-input--label"
                    value={target.label}
                    placeholder={String(t('settings.placeholders.label'))}
                    onChange={(event) =>
                    ...
                    aria-label={`${String(t('actions.openApp'))} ${String(t('settings.placeholders.label'))} ${index + 1}`}
                ...
                <label className="settings-open-app-field settings-open-app-field--type">
                  ...
                  <select
                    ...
                    aria-label={`${String(t('actions.openApp'))} ${String(t('common.type'))} ${index + 1}`}
                  >
                ...
                {target.kind === "app" && (
                  <label className="settings-open-app-field settings-open-app-field--appname">
                    <span className="settings-visually-hidden">{String(t('settings.placeholders.appName'))}</span>
                    <input
                      ...
                      placeholder={String(t('settings.placeholders.appName'))}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={`${String(t('actions.openApp'))} ${String(t('settings.placeholders.appName'))} ${index + 1}`}
                ...
                {target.kind === "command" && (
                  <label className="settings-open-app-field settings-open-app-field--command">
                    <span className="settings-visually-hidden">{String(t('settings.placeholders.command'))}</span>
                    <input
                      ...
                      placeholder={String(t('settings.placeholders.command'))}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={`${String(t('actions.openApp'))} ${String(t('settings.placeholders.command'))} ${index + 1}`}
                ...
                {target.kind !== "finder" && (
                  <label className="settings-open-app-field settings-open-app-field--args">
                    <span className="settings-visually-hidden">{String(t('settings.placeholders.args'))}</span>
                    <input
                      ...
                      placeholder={String(t('settings.placeholders.args'))}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={`${String(t('actions.openApp'))} ${String(t('common.args'))} ${index + 1}`}
                    />
                  </label>
                )}
              </div>
              <div className="settings-open-app-actions">
                ...
                <div className="settings-open-app-order">
                  <button
                    ...
                    disabled={index === 0}
                    aria-label={String(t('actions.moveUp'))}
                  >
                  ...
                  <button
                    ...
                    aria-label={String(t('actions.moveDown'))}
                  >
                ...
                <button
                  ...
                  aria-label={String(t('actions.remove'))}
                  title={String(t('actions.remove'))}
                >
                  <Trash2 aria-hidden />
                </button>
              </div>

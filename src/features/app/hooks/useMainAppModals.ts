...
type UseMainAppModalsArgs = {
  ...
  onCancelSwitchAccount: () => Promise<void>;
...
type BuildSettingsViewPropsArgs = {
  ...
  updater: UseMainAppModalsArgs["updater"];
};
...
function buildSettingsViewProps({
  ...
  return {
    ...
    onPluginsChanged: settings.onPluginsChanged,
    ...
    onCheckForUpdates: updateState.stage === "downloaded" ? updater.startUpdate : updater.checkForUpdates,
    updateState,
    updatesEnabled: true,
    isCheckingForUpdates: updateState.stage === "checking",
  };
}

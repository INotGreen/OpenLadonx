...
import { appendPlanLanguageInstruction } from "../../collaboration/utils/developerInstructions";
import { makePlanReadyAcceptMessage } from "../../../utils/internalPlanReadyMessages";
  ...
  const buildCollaborationModePayloadFor = useCallback(
    (mode: CollaborationModeOption | null) => {
      ...
      const settings: Record<string, unknown> = {
        developer_instructions: appendPlanLanguageInstruction(
          mode.developerInstructions,
          i18n.language,
        ),
      };
    ...
    [i18n.language, resolvedEffort, resolvedModel],
  );

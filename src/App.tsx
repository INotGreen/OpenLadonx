...
import "./styles/skills-store.css";
...
import "./styles/success-toasts.css";
...
const WechatAuthWindow = lazy(() =>
  import("@/features/app/components/AuthGate").then((module) => ({
    default: module.WechatAuthWindow,
  })),
);
